...
const AddCategoryDialog = ({getCategories}:{getCategories: ()=> void; }) => {
    ...
    return (
             <Dialog >
                ...
                <DialogContent className="sm:max-w-[460px] h-[272px] p-6 gap-4">
                    <DialogHeader>
                    ...
                    value={value}
                    onChange={handleChange}className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm placeholder:text-gray-400"
          />
                    <DialogClose asChild>
                        <div>
